...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "The public record of AI failures." },
...
export const siteConfig: SiteConfig = {
  domain: "aiincidents.org",
  url: "https://aiincidents.org",
  title: "AI Incidents",
  tagline: "AI incidents, model failures, and adversarial-use cases — dated and sourced.",
  description:
  ...
  byline: "AI Incidents Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 280, cluster: "news" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@aiincidents.org",
    abuse: "abuse@aiincidents.org",
    editor: "editor@aiincidents.org",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "aiincidents.org"),
  analytics: {},
};
